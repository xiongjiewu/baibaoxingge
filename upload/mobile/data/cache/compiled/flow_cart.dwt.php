<div class="con">
  ...
  <p class="flow-price ect-padding-lr ect-padding-tb"> <?php echo $this->_var['lang']['total']; ?><b id="total_number"><?php echo $this->_var['total']['total_number']; ?></b><?php echo $this->_var['lang']['total_number']; ?></p>
...
?>
  ...
  <?php else: ?>
  	...
  	<a href="<?php echo url('flow/consignee',array('direct_shopping'=>1));?>" type="button" class="btn btn-info ect-btn-info ect-bg"><?php echo $this->_var['lang']['check_out']; ?></a>
  </div>
  <?php endif; ?>
  ...
  <div class="flow-no-pro"> <img src="__TPL__/images/gwc.png">
    ...
    <a type="button" href="<?php echo url('category/index');?>" class="btn btn-info ect-btn-info ect-bg"><?php echo $this->_var['lang']['go_shopping']; ?></a> </div>
  <?php endif; ?>
</div>
