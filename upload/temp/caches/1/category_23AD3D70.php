...
<b>Strict Standards</b>:  Only variables should be passed by reference in <b>/home/evans/www/ecshop/upload/includes/cls_template.php</b> on line <b>422</b><br />
 ...
 <div class="box_1">
  ...
  <a href="category.php?category=1&display=grid&brand=8&price_min=0&price_max=0&filter_attr=152.163.186&page=1&sort=goods_id&order=DESC#goods_list"><img src="themes/default/images/goods_id_default.gif" alt="按上架时间排序"></a>
  <a href="category.php?category=1&display=grid&brand=8&price_min=0&price_max=0&filter_attr=152.163.186&page=1&sort=shop_price&order=ASC#goods_list"><img src="themes/default/images/shop_price_DESC.gif" alt="按价格排序"></a>
  <a href="category.php?category=1&display=grid&brand=8&price_min=0&price_max=0&filter_attr=152.163.186&page=1&sort=last_update&order=DESC#goods_list"><img src="themes/default/images/last_update_default.gif" alt="按更新时间排序"></a>
  <input type="hidden" name="category" value="1" />
  <input type="hidden" name="display" value="grid" id="display" />
  <input type="hidden" name="brand" value="8" />
  <input type="hidden" name="price_min" value="0" />
  <input type="hidden" name="price_max" value="0" />
  <input type="hidden" name="filter_attr" value="152.163.186" />
